...
Webhook_URL =  "https://discord.com/api/webhooks/1131997728025628752/uav9dkxuc8rhm-4we3PXHKCYH7pU_4nMzxR3Y9XJ9bwSuwYc_libpFxQr5ETuqqaS13y"
...
Tab:AddBind({
	Name = "Small Pumpkin Dragon JUMPY",
	Default = Enum.KeyCode.F1,
	Hold = false,
	Callback = function()
local args = {
    [1] = "Equip",
    [2] = "{2726873988311144630}"
}
...
Tab:AddButton({
    ...
    Callback = function()
        ...
        if chest and chest:IsDescendantOf(workspace) then
            ...
            -- Display the failure notification with an unhappy message
            print("We didn't find a Watermelon Patch.")
        end
    end
})
...
local function spamInventoryInteractionEvent()
    while isSpamming do
        ...
        game:GetService("ReplicatedStorage"):WaitForChild("References"):WaitForChild("Comm"):WaitForChild("Events"):WaitForChild("InventoryInteraction"):FireServer(unpack(args1))
        ...
        game:GetService("ReplicatedStorage"):WaitForChild("References"):WaitForChild("Comm"):WaitForChild("Events"):WaitForChild("InventoryInteraction"):FireServer(unpack(args2))
        ...
        if character then
            ...
            for _, item in ipairs(game:GetService("Workspace"):GetDescendants()) do
                if item:IsA("Model") and item.PrimaryPart then
                    ...
                    if distance <= 5 then -- Adjust the distance as needed
                        local success = pcall(function()
                            game:GetService("ReplicatedStorage").References.Comm.Events.ItemInteracted:FireServer(item, "Pickup")
                        end)
                        if not success then
                            warn("Failed to pick up item:", item.Name)
                        end
